...
public class TestExecuteOracleSQL {
    ...
    public void invokeOnTrigger(final Integer queryTimeout, final String query, final boolean incomingFlowFile, final boolean setQueryProperty)
        ...
        if (queryTimeout != null) {
            runner.setProperty(ExecuteOracleSQL.QUERY_TIMEOUT, queryTimeout.toString() + " secs");
        }
        ...
        if(setQueryProperty) {
            runner.setProperty(ExecuteOracleSQL.SQL_SELECT_QUERY, query);
        }
    ...
    /**
     * Simple implementation only for ExecuteOracleSQL processor testing.
     *
     */
